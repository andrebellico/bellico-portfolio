...
export default function Home() {
  return (
    <div className="my-10 mx-44">
      <h1 className="text-3xl font-semibold mb-1">Stack And Uses</h1>
      ...
      <div className="my-4">
        <h1 className="text-2xl font-semibold mb-4">Front-End</h1>
        <div className="grid gap-2 grid-cols-4">
          <div className="flex p-4 gap-4 bg-neutral-600 hover:bg-neutral-700 transition rounded items-center">
            <Avatar
              size="sm"
